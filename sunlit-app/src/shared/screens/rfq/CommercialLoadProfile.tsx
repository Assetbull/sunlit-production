...
export function CommercialLoadProfile({ data }: RFQScreenProps) {
        ...
        <div className="w-full xl:w-5/12 flex flex-col xl:sticky xl:top-32">
          <div className="mb-4">
            ...
            <h1 className="font-headline text-4xl lg:text-5xl font-extrabold tracking-[-0.02em] text-on-surface mb-6 leading-tight">
              Commercial <br className="hidden xl:block"/>Specifications
            </h1>
            <p className="font-body text-base text-on-surface-variant leading-relaxed max-w-md">
              {state.projectPath === 'appliance' 
                ? 'Select your facility\'s primary electrical loads. Our engine will calculate the required commercial solar capacity for maximum offset.' 
                : 'Detail the specifications of your existing or desired solar equipment for precise commercial EPC matching.'}
            </p>
          </div>
        </div>
            ...
            <div className="space-y-6">
              <section className="bg-surface-container-lowest border border-outline-variant/40 rounded-xl p-6 md:p-8 hover:border-outline-variant transition-colors shadow-sm">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="font-headline text-xl font-bold tracking-tight">Commercial Inverter Details</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="relative">
                    <label className="block text-xs font-bold text-on-surface-variant mb-2 uppercase tracking-wider">Phase / Type</label>
                    <select 
                      className="w-full bg-surface-container-low border border-outline-variant/40 rounded-xl px-4 py-3.5 focus:border-primary focus:ring-1 focus:ring-primary text-on-surface font-body appearance-none transition-colors font-medium"
                      value={state.invType}
                    ...
                    >
                      ...
                      <option value="3-Phase Hybrid">3-Phase Hybrid</option>
                      <option value="3-Phase Grid-Tied">3-Phase Grid-Tied</option>
              ...
              <section className="bg-surface-container-lowest border border-outline-variant/40 rounded-xl p-6 md:p-8 hover:border-outline-variant transition-colors shadow-sm">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="font-headline text-xl font-bold tracking-tight">Commercial Energy Storage</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <option value="Lithium-ion Rack">Lithium-ion Rack</option>
                      <option value="Lithium Iron Phosphate">Lithium Iron Phosphate (LiFePO4)</option>
              ...
              <section className="bg-surface-container-lowest border border-outline-variant/40 rounded-xl p-6 md:p-8 hover:border-outline-variant transition-colors shadow-sm">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="font-headline text-xl font-bold tracking-tight">Solar Panel Array</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center border border-outline-variant/40 bg-surface-container-low rounded-xl overflow-hidden">
                      <button type="button" onClick={() => onUpdate({ panelCount: String(Math.max(1, parseInt(state.panelCount||'50')-1)) })} className="p-3.5 text-on-surface-variant hover:bg-surface-variant transition-colors text-xl font-bold px-4">-</button>
                      ...
                      <button type="button" onClick={() => onUpdate({ panelCount: String(parseInt(state.panelCount||'50')+1) })} className="p-3.5 text-on-surface-variant hover:bg-surface-variant transition-colors text-xl font-bold px-4">+</button>
                    </div>
                  </div>
                  <div className="relative">
