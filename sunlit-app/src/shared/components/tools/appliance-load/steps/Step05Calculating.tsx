...
const LOAD_STAGES = [
  {
    title: 'Validating connected equipment inventory & wattage...',
    desc: 'Processing appliance power ratings and quantity specifications.',
  },
  {
    title: 'Aggregating active connected electrical load...',
    desc: 'Calculating continuous active power requirement across categories.',
  },
  {
    title: 'Analyzing motor startup inductive surge multipliers...',
    desc: 'Applying category-specific surge coefficients for ACs and pumps.',
  },
  {
    title: 'Modeling peak inverter demand & surge headroom...',
    desc: 'Simulating simultaneous startup surge peaks.',
  },
  {
    title: 'Computing daily & monthly kWh energy consumption...',
    desc: 'Multiplying operating hours per day by load profile.',
  },
  {
    title: 'Generating final appliance load engineering report...',
    desc: 'Synthesizing verified load metrics and export parameters.',
  },
];
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[440px] text-center py-6 px-4">
      ...
      <h1 className="font-headline font-extrabold text-2xl sm:text-3xl text-[#00490e] mb-2">
        Calculating Energy Demand Profile
      </h1>
      <p className="font-sans text-sm text-[#40493d] max-w-lg mx-auto mb-6 leading-relaxed">
        Analyzing motor startup inductive surge multipliers and continuous active connected load.
      </p>
