...
const STAGES = [
  'Analyzing backup loads & daily energy demand...',
  'Calculating required usable energy reserve...',
  'Applying round-trip inverter conversion efficiency...',
  'Applying depth-of-discharge (DoD %) safety limits...',
  'Applying ambient temperature derating factors...',
  'Sizing battery bank & module architecture...',
];
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[420px] text-center py-8 px-4">
      ...
      <span className="text-xs font-semibold text-[#00490e] uppercase tracking-widest mb-2 block">
        Battery Capacity Engineering Engine
      </span>
