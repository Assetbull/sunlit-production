...
const STAGES = [
  'Validating property profile & load input parameters...',
  'Mapping geographic solar irradiation & peak sun hours (PSH)...',
  'Calculating battery storage capacity & autonomy depth of discharge...',
  'Sizing peak continuous & surge hybrid inverter kVA rating...',
  'Synthesizing turnkey equipment configuration & DC bus compatibility...',
  'Generating verified engineering report & performance metrics...',
];
