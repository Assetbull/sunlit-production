...
const STAGES = [
  {
    title: 'Reading daily energy demand & property solar offset...',
    desc: 'Processing daily kWh targets and property tariff baseline.',
  },
  {
    title: 'Querying regional GHI solar irradiance & Peak Sun Hours...',
    desc: 'Fetching location-specific PSH data across Nigerian regions.',
  },
  {
    title: 'Applying STC module temperature & dust loss derating...',
    desc: 'Applying 18% IEC system efficiency loss factor.',
  },
  {
    title: 'Sizing total PV array kilowatt-peak (kWp) capacity...',
    desc: 'Calculating required DC array peak capacity.',
  },
  {
    title: 'Calculating recommended solar panel module quantity...',
    desc: 'Dividing total array kWp by selected panel module wattage.',
  },
  {
    title: 'Determining roof footprint area (m²) & string arrangement...',
    desc: 'Modeling series/parallel string layout and roof footprint.',
  },
];
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[440px] text-center py-6 px-4">
      ...
      <p className="font-sans text-sm text-[#40493d] max-w-lg mx-auto mb-6 leading-relaxed">
        Applying STC module temperature derating and location Peak Sun Hours to compute array capacity.
      </p>
