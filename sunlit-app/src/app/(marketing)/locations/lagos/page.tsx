  ...
  return (
    <>
      ...
      <main style={{ background: '#f9f9f6', minHeight: '100vh' }}>
        ...
        {/* Hero */}
        <section aria-label="Lagos hero" style={{ padding: '5rem 1.5rem 4rem', background: 'linear-gradient(180deg, #f4f4f1 0%, #f9f9f6 100%)', borderBottom: '1px solid rgba(191,202,186,0.2)' }}>
        ...
        {/* Stats */}
        <section aria-label="Lagos statistics" style={{ padding: '3.5rem 1.5rem', background: '#fff' }}>
