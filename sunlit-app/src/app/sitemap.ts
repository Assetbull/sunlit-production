...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    {
      url: `${SITE_URL}/services/residential-solar`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.85,
    },
    {
      url: `${SITE_URL}/services/commercial-solar`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.85,
    },
    {
      url: `${SITE_URL}/services/industrial-solar`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.85,
    },
    ...
    {
      url: `${SITE_URL}/services/energy-audits`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.85,
    },
    ...
    {
      url: `${SITE_URL}/services/battery-storage`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.85,
    },
    {
      url: `${SITE_URL}/services/ev-charging`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.85,
    },
    {
      url: `${SITE_URL}/services/solar-financing`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.85,
    },
    {
      url: `${SITE_URL}/services/monitoring`,
      lastModified: now,
      changeFrequency: 'weekly',
      priority: 0.85,
    },
    ...
    {
      url: `${SITE_URL}/legal/marketplace-terms`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.5,
    },
    {
      url: `${SITE_URL}/legal/escrow-terms`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.5,
    },
    ...
    {
      url: `${SITE_URL}/legal/security-disclosure`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.5,
    },
